...
//            pt.Last_Name[strlen(pt.Last_Name)-1] = '\0';
//            pt.Address[strlen(pt.Address)-1] = '\0';
//            pt.Email[strlen(pt.Email)-1] = '\0';
//            pt.Problem[strlen(pt.Problem)-1] = '\0';
//            pt.PatientId[strlen(pt.PatientId)-1] = '\0';
//            pt.Gender[strlen(pt.Gender)-1] = '\0';
//            pt.Contact_no[strlen(pt.Contact_no)-1] = '\0';
//            pt.DrName[strlen(pt.DrName)-1] = '\0';
